...
# Change 'PATH' into your own directory, for example: C:/GIAHUY/CleanTalk/, so PATH will be C:/GIAHUY
...
Open the frontend UI by following these steps:

```bash
# Create new terminal & change direction to CleanTalk\web\frontend\public
.venv\Scripts\activate
